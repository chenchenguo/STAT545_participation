...
```{r}
jsonlite::fromJSON("http://www.omdbapi.com/?t=Jurassic+Park&apikey=37955bc2")
jsonlite::fromJSON("http://www.omdbapi.com/?t=The+Wolf+of+Wall+Street&apikey=37955bc2")
```
...
```{r}
# use GET function to get a website
...
site1 <-GET("https://api.github.com/users/hadley/orgs")
status_code(
  site1
)
content(site1)
