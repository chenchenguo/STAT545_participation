...
# _x<- "My commute time, in minutes:"
# 1x <- "My commute time, in minutes:"
...
## 2. Using commas, add at least 2 more times from those around you.
 ...
 commute<- c(my_commute, 30, 17, 15, 50)
# R interpret everything into strings, character vector
#commute<- c(my_commute, 30, 17, 15, 50, "hi")
commute
class(commute)
...
(diffs<- commute - mu)
# R automatically loops the whole array
